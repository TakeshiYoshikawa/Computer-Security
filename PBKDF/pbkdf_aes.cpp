...
class PBKDF_AES{
    ...
    public:
        PBKDF_AES(): key(0x00, CryptoPP::AES::DEFAULT_KEYLENGTH), 
                     derived_key(0x00, CryptoPP::AES::DEFAULT_KEYLENGTH)
        {   
        ...
        void encrypt(CryptoPP::byte* _iv){
            try{
                ...
                CryptoPP::StringSource(print(_iv,CryptoPP::AES::BLOCKSIZE), true,
                    new CryptoPP::StreamTransformationFilter(e,
...
int main(){
    ...
    std::string plain = "CryptoPP CBC Mode Test";
    ...
    std::cout << "IV: " << process.print(process.getIv(), CryptoPP::AES::BLOCKSIZE) << std::endl;
    return 0;
}